...
src_prepare() {
	# Apply our patches
	EPATCH_EXCLUDE="8009_system_harfbuzz_graphite2_bug847568_v3.patch
		fix-arm-atomics-grsec.patch" \
		EPATCH_FORCE="yes" \
		EPATCH_SUFFIX="patch" \
		EPATCH_SOURCE="${WORKDIR}/firefox" epatch
	eapply "${FILESDIR}/"8009_system_harfbuzz_graphite2_bug847568_v3_v2.patch
	eapply "${FILESDIR}/"fix-arm-atomics-grsec.patch
