...
BUNDLED_LIBS="
	libQt5Core.so.5	   libQt5Core.so.5.9.2
	libQt5Gui.so.5	  libQt5Gui.so.5.9.2
	libQt5XcbQpa.so.5	 libQt5XcbQpa.so.5.9.2
	libQt5Multimedia.so.5	 libQt5Multimedia.so.5.9.2
	libQt5MultimediaWidgets.so.5	libQt5MultimediaWidgets.so.5.9.2
	libQt5DBus.so.5	   libQt5DBus.so.5.9.2
	libQt5Network.so.5	  libQt5Network.so.5.9.2
	libQt5PrintSupport.so.5	   libQt5PrintSupport.so.5.9.2
	libQt5Svg.so.5	  libQt5Svg.so.5.9.2
	libQt5OpenGL.so.5	 libQt5OpenGL.so.5.9.2
	libQt5Positioning.so.5	  libQt5Positioning.so.5.9.2
	libQt5Qml.so.5	  libQt5Qml.so.5.9.2
	libQt5Quick.so.5	libQt5Quick.so.5.9.2
	libQt5Sensors.so.5	  libQt5Sensors.so.5.9.2
	libQt5Sql.so.5	  libQt5Sql.so.5.9.2
	libQt5WebChannel.so.5	 libQt5WebChannel.so.5.9.2
	libQt5WebKit.so.5	 libQt5WebKit.so.5.9.0
	libQt5WebKitWidgets.so.5	libQt5WebKitWidgets.so.5.9.0
	libQt5Widgets.so.5	  libQt5Widgets.so.5.9.2
	libQt5X11Extras.so.5	libQt5X11Extras.so.5.9.2
	libQt5Xml.so.5	  libQt5Xml.so.5.9.2
	libQt5Concurrent.so.5	 libQt5Concurrent.so.5.9.2
